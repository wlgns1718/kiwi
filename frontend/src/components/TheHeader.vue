  ...
  <header class="header">
    <div class="wrap-header">
      ...
      <div class="header-center">
        <ul>
          <!-- <li><svg width="36" height="36" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3 14L14 3L25 14" stroke="#16191D" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"></path><path d="M5 24V12L14 3L23 12V24C23 24.5523 22.5523 25 22 25H17.25C16.6977 25 16.25 24.5523 16.25 24V19.4C16.25 18.8477 15.8023 18.4 15.25 18.4H12.75C12.1977 18.4 11.75 18.8477 11.75 19.4V24C11.75 24.5523 11.3023 25 10.75 25H6C5.44772 25 5 24.5523 5 24Z" stroke="#16191D" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"></path></svg></li> -->
          <li>
            <router-link to="/"><svg width="36" height="36" viewBox="0 0 28 28" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path d="M3 14L14 3L25 14" stroke="#0060FF" stroke-width="1.2" stroke-linecap="round"
                ...
                <path
                  ...
                  fill="#0060FF" stroke="#0060FF" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round">
                </path>
              </svg></router-link>
          </li>
          <li>
          ...
          <!-- <li style="padding-top: 5px"><svg width="30" height="30" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--gis" preserveAspectRatio="xMidYMid meet" fill="#0060FF"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M87.13 0a2.386 2.386 0 0 0-.64.088a2.386 2.386 0 0 0-.883.463L11.34 62.373a2.386 2.386 0 0 0 1.619 4.219l37.959-1.479l17.697 33.614a2.386 2.386 0 0 0 4.465-.707L89.486 2.79A2.386 2.386 0 0 0 87.131 0z" fill="#0060FF" fill-rule="evenodd"></path></g></svg></li> -->
        </ul>
      </div>
