  ...
  <header class="header">
    <div class="wrap-header">
      ...
      <div class="header-center">
        <ul>
          <li @click="navBtnToggle"><router-link to="/"><svg v-show="homeBtnOff" width="36" height="36"
                viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M3 14L14 3L25 14" stroke="#16191D" stroke-width="1.2" stroke-linecap="round"
                ...
                <path
                  ...
                  stroke="#16191D" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"></path>
              </svg></router-link></li>
          <li @click="navBtnToggle">
            <router-link to="/"><svg v-show="homeBtnOn" width="36" height="36" viewBox="0 0 28 28" fill="none"
          ...
          <li @click="navBtnToggle">
            <router-link to="/board">
              <svg v-show="boardBtnOff" width="36" height="36" viewBox="0 0 28 28" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <li><router-link to="/board"><svg v-show="boardBtnOn" width="36" height="36" viewBox="0 0 29 28" fill="none"
                xmlns="http://www.w3.org/2000/svg">
          ...
          <li style="padding-top: 5px" @click="navBtnToggle">
            <router-link to="/tour">
              <svg v-show="tourBtnOff" width="30" height="30" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"
          ...
          <li style="padding-top: 5px"><router-link to="/tour"><svg v-show="tourBtnOn" width="30" height="30"
                viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                aria-hidden="true" role="img" class="iconify iconify--gis" preserveAspectRatio="xMidYMid meet"
                fill="#0060FF">
                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                <g id="SVGRepo_iconCarrier">
                  <path
                    ...
                    fill="#0060FF" fill-rule="evenodd"></path>
                </g>
              </svg></router-link></li>
        </ul>
      </div>
